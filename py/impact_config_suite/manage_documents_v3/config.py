...
# API Configuration
BASE_URL = \
https://impactonlinebackend.newgen.co/IMPACT\
HTTP_TIMEOUT = 30
...
# Threading
THREAD_COUNT = 4
THREADED_DOWNLOAD_WORKERS = 4  # Default workers for threaded downloads
THREADED_DOWNLOAD_BATCH = 25   # Files per batch for threaded downloads
